        ...
        <div className="min-h-screen bg-[#FAFAFA] text-[#18181B] p-8 md:p-12 font-sans">
            <div className="max-w-4xl mx-auto">
                <header className="mb-12 flex items-center gap-4">
                    ...
                    <h1 className="text-3xl font-black uppercase tracking-tighter">Add <span className="text-[#71717A] font-light italic">Project</span></h1>
                </header>

                <form action={createProject} className="bg-white p-8 md:p-10 rounded-2xl border border-black/5 shadow-sm space-y-6">
                    <div>
                    ...
                    <div>
                        ...
                        <input className="w-full p-4 bg-[#FAFAFA] border border-black/10 rounded-xl focus:border-[#18181B] focus:outline-none" id="tags" name="tags" type="text" placeholder="React, Node.js, Python" required />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea className="w-full p-4 bg-[#FAFAFA] border border-black/10 rounded-xl focus:border-[#18181B] focus:outline-none min-h-[150px]" id="description" name="description" required></textarea>
                    </div>
